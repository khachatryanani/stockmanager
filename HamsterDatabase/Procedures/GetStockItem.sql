CREATE PROCEDURE [dbo].[GetStockItem]
	@stockItemId int
AS
	...
	WHERE ExpirationDate > '2020-12-12' AND StockWithExpirationDates.ActualQuantity > 0 AND StockWithExpirationDates.StockId = @stockItemId
RETURN
